        ...
        <form id="form1" name="form1" method="post" action="../insertdata/insertdata.php">
                                        ...
                                        <div class="row">
                                            ...
                                            <label >Student ID</label>  
                                                <input class="form-control input-sm" name="studentidno" placeholder=
                                                                    "" type="text" value="<?=  $studentid  ?>" readonly>
                                            </div> 
                                            </div>  
                                            ...
                                            <label >Learner Reference Number:*</label>  
                                                <input class="form-control input-sm" name="lrn" placeholder=
                                                                    "" type="number" value="<?= $lrn ?>" required>
                                            </div> 
                                            </div>  
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                "date" placeholder="" value="<?= $birthdate ?>" required>
                                                </div>
                                            </div>
                              ...
                              <a href='managestudent.php'><input type='button' class='addbtn' value='Go Back' formnovalidate>  </a>   
                              <input class=addbtn type="submit" id=btncreate name="btnsaveinfostudent"value="Save" >
