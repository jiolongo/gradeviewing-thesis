...
<?php 
          ...
          $query = "SELECT *  FROM tblsubjloadstudent WHERE studentid IN ('$usern') and schoolyear in ('$sy')";
...
<div class="mains" >   
          ...
          <div class="col">
              ...
              <div class="row justify-content-center">
                  ...
                  <div class="name-student"><b><?php echo $u_fname .' '.substr($u_mname,0, 1).'. ' .$u_lname.""; ?> </b> <br></div> 
                    <div class="section-student">   <?php echo $gradesection?></div> 

                    <form id="myForm" action="studentp1.php">
        ...
        <div class="table-responsive" >
            <table id="styled-table" class="table table-bordered table-striped table-hover " style="width:100%">
                  ...
                  <?php 
                    $queryres = "SELECT *  FROM tblsubjloadstudent WHERE studentid IN ('$usern') and schoolyear in ('$sy')";
       ...
       <a href='studenthomepage.php' id="goback"> <input type='button' class='addbtn' value='Go Back'  ></a>   
      <button onclick="window.print();" class="addbtn" id="print-btn">Print Preview</button>
